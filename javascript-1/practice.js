...
const middleNums = numbers.slice(1, 2, 3, 4)
...
let filtered = myNumbers.filter(filtering)
...
const total = myNumbers.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
...
const totallyAwesome = people.reduce((accumulator, level) => {
